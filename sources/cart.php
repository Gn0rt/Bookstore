...
<body>
    ...
    <?php 
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['buy'])) {
            $createOrder = $order->createNewOrder($usId);
        ...
        <div id="cart">
            <form action="" method="POST">
                ...
                <div class="cart__btn-buy">
                    <!-- <a href="./confirmbuy.php" name="buy" class="btn btn-outline-success">Mua hàng</a> -->
                    <button type="submit" name="buy" class="btn btn-outline-success">Thanh toán (COD)</button>
                    <!-- <button type="submit" name="vnpay" class="btn btn-outline-primary ms-1">Thanh toán online</button> -->
                    <a  href="./onlinepayment.php" class="btn btn-outline-primary ms-1">Thanh toán online</a>
