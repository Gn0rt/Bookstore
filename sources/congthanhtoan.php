...
$vnp_TmnCode = "702S7C2B"; //Mã định danh merchant kết nối (Terminal Id)
$vnp_HashSecret = "FYT53VQS52IWNHV9ZBEX4I1FNX6RAEDG"; //Secret key
$vnp_Url = "https://sandbox.vnpayment.vn/paymentv2/vpcpay.html";
$vnp_Returnurl = "http://localhost/webMVC/vnpay_return.php";
...
$vnp_Amount = $_POST['total_gate']; // Số tiền thanh toán
